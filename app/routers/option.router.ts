...
import { createOptionSchema,UpdateOptionSchema, createValuesSchema ,updateValuesSchema} from '../validators/option.validator';
const router = Router();
...
router.put('/:id',UpdateOptionSchema,validateRequest, updates);
router.put('/updatevalues/:id',updateValuesSchema,validateRequest,  updateValues);
//upload, updateFaqSchema,verifyToken,
router.post('/create',createOptionSchema,validateRequest ,create);
